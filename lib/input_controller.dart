...
/// How many pixels from the anchor point the player has to move their finger to
/// trigger movement.
...
/// Triggered when the player places their finger on the screen. Capture
/// the anchor point here.
///
...
///
/// @param inDetails The object describing the gesture. Note this can be
/// multiple types, hence dynamic.
